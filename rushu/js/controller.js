...
rushuApp.controller('UsersCtrl', function ($scope, $http, UserService, $rootScope, $location, $modal) {
...
rushuApp.controller('LoginCtrl', function ($scope, $http, UserService, Base64, $rootScope, $location) {
...
rushuApp.controller('DashboardCtrl', function ($scope, $rootScope, $location) {
    if (typeof  $rootScope.loggedin == 'undefined' || $rootScope.loggedin == false) {
        $location.path('/login');
        return;
    }
...
rushuApp.controller('GroupsCtrl', function ($scope, $rootScope, $location, GroupService,$modal) {
    if (typeof  $rootScope.loggedin == 'undefined' || $rootScope.loggedin == false) {
        $location.path('/login');
        return;
    }
...
rushuApp.factory('Base64', function () {
